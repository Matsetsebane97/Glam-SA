...
urlpatterns = [
    ...
    path("users/<int:owner_id>/services/", views.services),
    path("services/", views.services),
    path("services/<int:service_id>/", views.services),
    path("users/<int:owner_id>/availability/", views.availability),
    path("availability/", views.availability),
    path("availability/<int:slot_id>/", views.availability),
